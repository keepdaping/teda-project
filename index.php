...
<section id="gallery" class="section section--parallax dark-section">
    ...
    <div class="container">
        ...
        <div class="carousel-wrapper">
            <button class="carousel-btn carousel-btn--prev" onclick="scrollGallery(-1)">&#8592;</button>
            ...
            <button class="carousel-btn carousel-btn--next" onclick="scrollGallery(1)">&#8594;</button>
        </div>
    </div>
</section>
        ...
        <div class="block-sep">
            ...
            <div class="donate-grid">
                <div class="donate-panel">
                    ...
                    <a href="https://www.paypal.com/donate" target="_blank" class="btn btn-primary">Donate</a>
                </div>
